...
class AthleteProfile {
  ...
  double? get acwr => (chronicWorkload != null && chronicWorkload! > 0)
  ...
  AthleteProfile copyWith({
    ...
    biomechanicConstantB0: biomechanicConstantB0 ?? this.biomechanicConstantB0,
    cadenceCoefficientB1: cadenceCoefficientB1 ?? this.cadenceCoefficientB1,
