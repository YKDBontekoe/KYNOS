...
| `lib/features/settings/presentation/pages/settings_page.dart` | 596 | SettingsPage, _SettingsPageState, _SwitchTile, … |
...
| File | Lines | Target |
|------|------:|--------|
| `lib/features/settings/presentation/pages/settings_page.dart` | 596 | Split if > 250 lines |
...
_Generated by `dart run tool/generate_codemap.dart` — 345 hand-written Dart files._
