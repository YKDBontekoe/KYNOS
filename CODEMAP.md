...
| `lib/features/coach_chat/providers/coach_context_provider.dart` | 64 | Builds unified runner context for coach inference. |
...
_Generated by `dart run tool/generate_codemap.dart` — 304 hand-written Dart files._
