...
| `lib/app/shell_page.dart` | 163 | `ShellPage, _AnimatedShellBody, _AnimatedShellBodyState, …` |
...
| `lib/shared/widgets/kynos_floating_nav.dart` | 392 | `KynosFloatingNavItem, KynosFloatingNav, _KynosFloatingNavState, …` |
...
| `lib/shared/widgets/kynos_floating_nav.dart` | 392 | Split if > 250 lines |
